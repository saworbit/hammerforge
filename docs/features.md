...
The verified Godot 4.7 suite on September 17, 2026 contains **4,111 tests across 222 scripts**: **4,104 passing tests**, seven intentional no-assert safety tests, and **19,762 assertions**. All checks run on every push and pull request via GitHub Actions.
