...
The verified Godot 4.7 suite on September 12, 2026 contains **3,665 tests across 192 scripts**: **3,658 passing tests**, seven intentional no-assert safety tests, and **18,501 assertions**. All checks run on every push and pull request via GitHub Actions.
