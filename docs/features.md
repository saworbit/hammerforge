...
The verified Godot 4.7 suite on September 16, 2026 contains **3,910 tests across 211 scripts**: **3,903 passing tests**, seven intentional no-assert safety tests, and **19,220 assertions**. All checks run on every push and pull request via GitHub Actions.
