...
The verified Godot 4.7 suite on September 16, 2026 contains **4,093 tests across 222 scripts**: **4,086 passing tests**, seven intentional no-assert safety tests, and **19,729 assertions**. All checks run on every push and pull request via GitHub Actions.
