...
The verified Godot 4.7 suite on September 16, 2026 contains **4,017 tests across 216 scripts**: **4,010 passing tests**, seven intentional no-assert safety tests, and **19,524 assertions**. All checks run on every push and pull request via GitHub Actions.
