...
The verified Godot 4.7 suite on September 15, 2026 contains **3,824 tests across 207 scripts**: **3,817 passing tests**, seven intentional no-assert safety tests, and **18,982 assertions**. All checks run on every push and pull request via GitHub Actions.
