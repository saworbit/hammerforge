...
The verified Godot 4.7 suite on September 16, 2026 contains **4,084 tests across 221 scripts**: **4,077 passing tests**, seven intentional no-assert safety tests, and **19,707 assertions**. All checks run on every push and pull request via GitHub Actions.
