...
The verified Godot 4.7 suite on September 16, 2026 contains **3,911 tests across 212 scripts**: **3,904 passing tests**, seven intentional no-assert safety tests, and **19,208 assertions**. All checks run on every push and pull request via GitHub Actions.
