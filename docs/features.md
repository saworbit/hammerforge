...
The verified Godot 4.7 suite on September 17, 2026 contains **4,224 tests across 235 scripts**: **4,217 passing tests**, seven intentional no-assert safety tests, and **20,120 assertions**. All checks run on every push and pull request via GitHub Actions.
