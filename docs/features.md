...
The verified Godot 4.7 suite on September 12, 2026 contains **3,666 tests across 193 scripts**: **3,659 passing tests**, seven intentional no-assert safety tests, and **18,487 assertions**. All checks run on every push and pull request via GitHub Actions.
