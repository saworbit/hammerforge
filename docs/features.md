...
The verified Godot 4.7 suite on September 17, 2026 contains **4,323 tests across 238 scripts**: **4,316 passing tests**, seven intentional no-assert safety tests, and **20,384 assertions**. All checks run on every push and pull request via GitHub Actions.
