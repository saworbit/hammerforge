...
The verified Godot 4.7 suite on September 19, 2026 contains **4,491 tests across 247 scripts**: **4,484 passing tests**, seven intentional no-assert safety tests, and **20,849 assertions**. All checks run on every push and pull request via GitHub Actions.
