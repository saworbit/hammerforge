...
The verified Godot 4.7 suite on September 16, 2026 contains **3,980 tests across 214 scripts**: **3,973 passing tests**, seven intentional no-assert safety tests, and **19,441 assertions**. All checks run on every push and pull request via GitHub Actions.
