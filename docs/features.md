...
The verified Godot 4.7 suite on September 18, 2026 contains **4,426 tests across 243 scripts**: **4,419 passing tests**, seven intentional no-assert safety tests, and **20,672 assertions**. All checks run on every push and pull request via GitHub Actions.
