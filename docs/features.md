...
The verified Godot 4.7 suite on September 17, 2026 contains **4,136 tests across 225 scripts**: **4,129 passing tests**, seven intentional no-assert safety tests, and **19,892 assertions**. All checks run on every push and pull request via GitHub Actions.
