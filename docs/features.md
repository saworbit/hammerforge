...
The verified Godot 4.7 suite on September 8, 2026 contains **2,922 tests across 153 scripts**: **2,915 passing tests**, seven intentional no-assert safety tests, and **15,393 assertions**. All checks run on every push and pull request via GitHub Actions.
