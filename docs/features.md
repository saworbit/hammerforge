...
The verified Godot 4.7 suite on September 16, 2026 contains **4,037 tests across 218 scripts**: **4,030 passing tests**, seven intentional no-assert safety tests, and **19,570 assertions**. All checks run on every push and pull request via GitHub Actions.
