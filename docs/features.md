...
The verified Godot 4.7 suite on September 17, 2026 contains **4,127 tests across 224 scripts**: **4,120 passing tests**, seven intentional no-assert safety tests, and **19,807 assertions**. All checks run on every push and pull request via GitHub Actions.
