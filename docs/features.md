...
The verified Godot 4.7 suite on September 16, 2026 contains **3,921 tests across 213 scripts**: **3,914 passing tests**, seven intentional no-assert safety tests, and **19,271 assertions**. All checks run on every push and pull request via GitHub Actions.
