...
The verified Godot 4.7 suite on September 15, 2026 contains **3,876 tests across 208 scripts**: **3,869 passing tests**, seven intentional no-assert safety tests, and **19,150 assertions**. All checks run on every push and pull request via GitHub Actions.
