...
The verified Godot 4.7 suite on September 17, 2026 contains **4,305 tests across 237 scripts**: **4,298 passing tests**, seven intentional no-assert safety tests, and **20,323 assertions**. All checks run on every push and pull request via GitHub Actions.
