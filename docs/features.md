...
The verified Godot 4.7 suite on September 9, 2026 contains **3,198 tests across 164 scripts**: **3,191 passing tests**, seven intentional no-assert safety tests, and **16,445 assertions**. All checks run on every push and pull request via GitHub Actions.
