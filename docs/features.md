...
The verified Godot 4.7 suite on September 15, 2026 contains **3,815 tests across 207 scripts**: **3,808 passing tests**, seven intentional no-assert safety tests, and **18,879 assertions**. All checks run on every push and pull request via GitHub Actions.
