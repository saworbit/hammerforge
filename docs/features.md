...
The verified Godot 4.7 suite on September 18, 2026 contains **4,371 tests across 242 scripts**: **4,364 passing tests**, seven intentional no-assert safety tests, and **20,509 assertions**. All checks run on every push and pull request via GitHub Actions.
