...
The verified Godot 4.7 suite on September 9, 2026 contains **3,155 tests across 162 scripts**: **3,148 passing tests**, seven intentional no-assert safety tests, and **16,380 assertions**. All checks run on every push and pull request via GitHub Actions.
