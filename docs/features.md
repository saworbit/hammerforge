...
The verified Godot 4.7 suite on September 16, 2026 contains **4,024 tests across 217 scripts**: **4,017 passing tests**, seven intentional no-assert safety tests, and **19,544 assertions**. All checks run on every push and pull request via GitHub Actions.
