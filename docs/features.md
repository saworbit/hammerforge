...
The verified Godot 4.7 suite on September 17, 2026 contains **4,186 tests across 233 scripts**: **4,179 passing tests**, seven intentional no-assert safety tests, and **20,028 assertions**. All checks run on every push and pull request via GitHub Actions.
