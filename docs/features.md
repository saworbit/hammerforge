...
The verified Godot 4.7 suite on September 16, 2026 contains **4,007 tests across 215 scripts**: **4,000 passing tests**, seven intentional no-assert safety tests, and **19,504 assertions**. All checks run on every push and pull request via GitHub Actions.
