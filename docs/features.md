...
The verified Godot 4.7 suite on September 18, 2026 contains **4,396 tests across 242 scripts**: **4,389 passing tests**, seven intentional no-assert safety tests, and **20,608 assertions**. All checks run on every push and pull request via GitHub Actions.
