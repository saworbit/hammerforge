...
The verified Godot 4.7 suite on September 17, 2026 contains **4,117 tests across 223 scripts**: **4,110 passing tests**, seven intentional no-assert safety tests, and **19,788 assertions**. All checks run on every push and pull request via GitHub Actions.
