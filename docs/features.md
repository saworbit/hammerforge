...
The verified Godot 4.7 suite on September 12, 2026 contains **3,682 tests across 194 scripts**: **3,675 passing tests**, seven intentional no-assert safety tests, and **18,539 assertions**. All checks run on every push and pull request via GitHub Actions.
