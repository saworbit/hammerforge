...
The verified Godot 4.7 suite on September 9, 2026 contains **3,081 tests across 160 scripts**: **3,074 passing tests**, seven intentional no-assert safety tests, and **16,031 assertions**. All checks run on every push and pull request via GitHub Actions.
