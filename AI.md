...
Nothing shipping today came out of an image model. Here is how each thing was
actually made, including one that used to be different.
...
- **There was an AI generated logo before that one.** I retired it and drew the
  current mark myself.
  [Issue 61](https://github.com/saworbit/hammerforge/issues/61) has the brief that
  went out and the reasoning behind what replaced it.
