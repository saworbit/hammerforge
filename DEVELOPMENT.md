...
- **GUT unit + integration tests** -- 3,307 tests across 171 test scripts (3,300 passing plus seven intentional no-assert safety tests; 16,783 assertions; verified in CI on September 10, 2026; runs Godot headless)
