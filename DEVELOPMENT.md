...
- **GUT unit + integration tests** -- 3,925 tests across 213 test scripts (3,918 passing plus seven intentional no-assert safety tests; 19,279 assertions; verified in CI on September 16, 2026; runs Godot headless)
