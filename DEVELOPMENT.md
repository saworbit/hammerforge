...
- **GUT unit + integration tests** -- 3,915 tests across 213 test scripts (3,908 passing plus seven intentional no-assert safety tests; 19,215 assertions; verified in CI on September 16, 2026; runs Godot headless)
