...
- **GUT unit + integration tests** -- 3,976 tests across 214 test scripts (3,969 passing plus seven intentional no-assert safety tests; 19,435 assertions; verified in CI on September 16, 2026; runs Godot headless)
