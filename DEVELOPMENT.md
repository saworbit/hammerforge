...
- **GUT unit + integration tests** -- 3,314 tests across 171 test scripts (3,307 passing plus seven intentional no-assert safety tests; 16,788 assertions; verified in CI on September 10, 2026; runs Godot headless)
