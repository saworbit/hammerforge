...
- **GUT unit + integration tests** -- 3,818 tests across 207 test scripts (3,811 passing plus seven intentional no-assert safety tests; 18,972 assertions; verified in CI on September 15, 2026; runs Godot headless)
