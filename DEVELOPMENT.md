...
- **GUT unit + integration tests** -- 3,817 tests across 207 test scripts (3,810 passing plus seven intentional no-assert safety tests; 18,886 assertions; verified in CI on September 15, 2026; runs Godot headless)
