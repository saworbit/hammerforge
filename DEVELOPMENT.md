...
- **GUT unit + integration tests** -- 4,151 tests across 227 test scripts (4,144 passing plus seven intentional no-assert safety tests; 19,918 assertions; verified in CI on September 17, 2026; runs Godot headless)
