...
- **GUT unit + integration tests** -- 3,918 tests across 213 test scripts (3,911 passing plus seven intentional no-assert safety tests; 19,222 assertions; verified in CI on September 16, 2026; runs Godot headless)
