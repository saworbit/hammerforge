...
- **GUT unit + integration tests** -- 3,911 tests across 212 test scripts (3,904 passing plus seven intentional no-assert safety tests; 19,210 assertions; verified in CI on September 16, 2026; runs Godot headless)
