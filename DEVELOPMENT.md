...
- **GUT unit + integration tests** -- 2,887 tests across 152 test scripts (2,880 passing plus seven intentional no-assert safety tests; 15,240 assertions; verified locally September 8, 2026; runs Godot headless)
