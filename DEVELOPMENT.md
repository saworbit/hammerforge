...
- **GUT unit + integration tests** -- 3,930 tests across 213 test scripts (3,923 passing plus seven intentional no-assert safety tests; 19,304 assertions; verified in CI on September 16, 2026; runs Godot headless)
