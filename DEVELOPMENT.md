...
- **GUT unit + integration tests** -- 2,951 tests across 154 test scripts (2,944 passing plus seven intentional no-assert safety tests; 15,481 assertions; verified in CI on September 8, 2026; runs Godot headless)
