...
- **GUT unit + integration tests** -- 3,995 tests across 214 test scripts (3,988 passing plus seven intentional no-assert safety tests; 19,491 assertions; verified in CI on September 16, 2026; runs Godot headless)
