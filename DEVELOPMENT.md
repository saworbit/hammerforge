...
- **GUT unit + integration tests** -- 3,665 tests across 192 test scripts (3,658 passing plus seven intentional no-assert safety tests; 18,501 assertions; verified in CI on September 12, 2026; runs Godot headless)
