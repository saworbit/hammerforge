...
- **GUT unit + integration tests** -- 3,198 tests across 164 test scripts (3,191 passing plus seven intentional no-assert safety tests; 16,445 assertions; verified in CI on September 9, 2026; runs Godot headless)
