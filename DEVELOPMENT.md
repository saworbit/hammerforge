...
- **GUT unit + integration tests** -- 2,557 tests across 137 test scripts (2,550 passing plus seven intentional no-assert safety tests; 13,304 assertions; verified locally September 8, 2026; runs Godot headless)
