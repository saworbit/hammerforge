...
- **GUT unit + integration tests** -- 3,035 tests across 158 test scripts (3,028 passing plus seven intentional no-assert safety tests; 15,869 assertions; verified in CI on September 9, 2026; runs Godot headless)
