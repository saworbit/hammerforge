...
- **GUT unit + integration tests** -- 2,364 tests across 129 test scripts (2,357 passing plus seven intentional no-assert safety tests; 9,821 assertions; verified locally September 7, 2026; runs Godot headless)
