...
- **GUT unit + integration tests** -- 3,824 tests across 207 test scripts (3,817 passing plus seven intentional no-assert safety tests; 18,982 assertions; verified in CI on September 15, 2026; runs Godot headless)
