...
- **GUT unit + integration tests** -- 2,582 tests across 137 test scripts (2,575 passing plus seven intentional no-assert safety tests; 10,934 assertions; verified locally September 8, 2026; runs Godot headless)
