...
- **GUT unit + integration tests** -- 3,961 tests across 213 test scripts (3,954 passing plus seven intentional no-assert safety tests; 19,395 assertions; verified in CI on September 16, 2026; runs Godot headless)
