...
- **GUT unit + integration tests** -- 3,926 tests across 213 test scripts (3,919 passing plus seven intentional no-assert safety tests; 19,280 assertions; verified in CI on September 16, 2026; runs Godot headless)
