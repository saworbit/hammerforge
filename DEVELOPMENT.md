...
- **GUT unit + integration tests** -- 3,943 tests across 213 test scripts (3,936 passing plus seven intentional no-assert safety tests; 19,344 assertions; verified in CI on September 16, 2026; runs Godot headless)
