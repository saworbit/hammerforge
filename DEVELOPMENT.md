...
- **GUT unit + integration tests** -- 3,180 tests across 163 test scripts (3,173 passing plus seven intentional no-assert safety tests; 16,415 assertions; verified in CI on September 9, 2026; runs Godot headless)
