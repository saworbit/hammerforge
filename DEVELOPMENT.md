...
- **GUT unit + integration tests** -- 3,894 tests across 209 test scripts (3,887 passing plus seven intentional no-assert safety tests; 19,188 assertions; verified in CI on September 15, 2026; runs Godot headless)
