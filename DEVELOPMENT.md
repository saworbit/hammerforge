...
- **GUT unit + integration tests** -- 4,233 tests across 235 test scripts (4,226 passing plus seven intentional no-assert safety tests; 20,150 assertions; verified in CI on September 17, 2026; runs Godot headless)
