...
- **GUT unit + integration tests** -- 4,117 tests across 223 test scripts (4,110 passing plus seven intentional no-assert safety tests; 19,788 assertions; verified in CI on September 17, 2026; runs Godot headless)
