...
- **GUT unit + integration tests** -- 3,924 tests across 213 test scripts (3,917 passing plus seven intentional no-assert safety tests; 19,276 assertions; verified in CI on September 16, 2026; runs Godot headless)
