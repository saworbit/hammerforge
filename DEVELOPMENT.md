...
- **GUT unit + integration tests** -- 3,671 tests across 194 test scripts (3,664 passing plus seven intentional no-assert safety tests; 18,485 assertions; verified in CI on September 12, 2026; runs Godot headless)
