...
- **GUT unit + integration tests** -- 4,142 tests across 226 test scripts (4,135 passing plus seven intentional no-assert safety tests; 19,905 assertions; verified in CI on September 17, 2026; runs Godot headless)
