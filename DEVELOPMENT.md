...
- **GUT unit + integration tests** -- 4,136 tests across 225 test scripts (4,129 passing plus seven intentional no-assert safety tests; 19,892 assertions; verified in CI on September 17, 2026; runs Godot headless)
