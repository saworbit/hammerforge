...
- **GUT unit + integration tests** -- 4,246 tests across 235 test scripts (4,239 passing plus seven intentional no-assert safety tests; 20,186 assertions; verified in CI on September 17, 2026; runs Godot headless)
