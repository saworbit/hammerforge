...
- **GUT unit + integration tests** -- 3,880 tests across 208 test scripts (3,873 passing plus seven intentional no-assert safety tests; 19,158 assertions; verified in CI on September 15, 2026; runs Godot headless)
