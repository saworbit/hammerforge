...
- **GUT unit + integration tests** -- 3,921 tests across 213 test scripts (3,914 passing plus seven intentional no-assert safety tests; 19,240 assertions; verified in CI on September 16, 2026; runs Godot headless)
