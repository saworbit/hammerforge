...
- **GUT unit + integration tests** -- 3,335 tests across 171 test scripts (3,328 passing plus seven intentional no-assert safety tests; 16,917 assertions; verified in CI on September 11, 2026; runs Godot headless)
