...
- **GUT unit + integration tests** -- 3,968 tests across 213 test scripts (3,961 passing plus seven intentional no-assert safety tests; 19,422 assertions; verified in CI on September 16, 2026; runs Godot headless)
