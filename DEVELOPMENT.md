...
- **GUT unit + integration tests** -- 3,967 tests across 213 test scripts (3,960 passing plus seven intentional no-assert safety tests; 19,400 assertions; verified in CI on September 16, 2026; runs Godot headless)
