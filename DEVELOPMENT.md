...
- **GUT unit + integration tests** -- 4,017 tests across 216 test scripts (4,010 passing plus seven intentional no-assert safety tests; 19,524 assertions; verified in CI on September 16, 2026; runs Godot headless)
