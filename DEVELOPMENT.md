...
- **GUT unit + integration tests** -- 4,512 tests across 248 test scripts (4,505 passing plus seven intentional no-assert safety tests; 20,894 assertions; verified in CI on September 20, 2026; runs Godot headless)
