...
- **GUT unit + integration tests** -- 3,931 tests across 213 test scripts (3,924 passing plus seven intentional no-assert safety tests; 19,305 assertions; verified in CI on September 16, 2026; runs Godot headless)
