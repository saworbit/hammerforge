...
- **GUT unit + integration tests** -- 3,322 tests across 171 test scripts (3,315 passing plus seven intentional no-assert safety tests; 16,847 assertions; verified in CI on September 10, 2026; runs Godot headless)
