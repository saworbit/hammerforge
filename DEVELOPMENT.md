...
- **GUT unit + integration tests** -- 3,325 tests across 171 test scripts (3,318 passing plus seven intentional no-assert safety tests; 16,853 assertions; verified in CI on September 10, 2026; runs Godot headless)
