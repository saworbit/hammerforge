...
- **GUT unit + integration tests** -- 4,496 tests across 247 test scripts (4,489 passing plus seven intentional no-assert safety tests; 20,873 assertions; verified in CI on September 20, 2026; runs Godot headless)
