...
- **GUT unit + integration tests** -- 2,486 tests across 133 test scripts (2,479 passing plus seven intentional no-assert safety tests; 10,436 assertions; verified locally September 7, 2026; runs Godot headless)
