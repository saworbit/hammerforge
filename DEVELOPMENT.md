...
- **GUT unit + integration tests** -- 3,914 tests across 212 test scripts (3,907 passing plus seven intentional no-assert safety tests; 19,215 assertions; verified in CI on September 16, 2026; runs Godot headless)
