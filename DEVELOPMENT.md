...
- **GUT unit + integration tests** -- 3,970 tests across 213 test scripts (3,963 passing plus seven intentional no-assert safety tests; 19,420 assertions; verified in CI on September 16, 2026; runs Godot headless)
