...
- **GUT unit + integration tests** -- 4,361 tests across 241 test scripts (4,354 passing plus seven intentional no-assert safety tests; 20,505 assertions; verified in CI on September 18, 2026; runs Godot headless)
