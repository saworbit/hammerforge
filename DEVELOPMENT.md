...
- **GUT unit + integration tests** -- 4,323 tests across 238 test scripts (4,316 passing plus seven intentional no-assert safety tests; 20,384 assertions; verified in CI on September 17, 2026; runs Godot headless)
