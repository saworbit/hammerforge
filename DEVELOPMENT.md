...
- **GUT unit + integration tests** -- 3,981 tests across 213 test scripts (3,974 passing plus seven intentional no-assert safety tests; 19,444 assertions; verified in CI on September 16, 2026; runs Godot headless)
