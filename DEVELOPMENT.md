...
- **GUT unit + integration tests** -- 3,960 tests across 213 test scripts (3,953 passing plus seven intentional no-assert safety tests; 19,382 assertions; verified in CI on September 16, 2026; runs Godot headless)
