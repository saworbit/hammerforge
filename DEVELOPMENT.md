...
- **GUT unit + integration tests** -- 3,934 tests across 213 test scripts (3,927 passing plus seven intentional no-assert safety tests; 19,313 assertions; verified in CI on September 16, 2026; runs Godot headless)
