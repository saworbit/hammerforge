...
- **GUT unit + integration tests** -- 4,333 tests across 239 test scripts (4,326 passing plus seven intentional no-assert safety tests; 20,398 assertions; verified in CI on September 17, 2026; runs Godot headless)
