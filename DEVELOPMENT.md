...
- **GUT unit + integration tests** -- 4,447 tests across 243 test scripts (4,440 passing plus seven intentional no-assert safety tests; 20,753 assertions; verified in CI on September 18, 2026; runs Godot headless)
