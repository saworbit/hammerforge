...
- **GUT unit + integration tests** -- 4,438 tests across 243 test scripts (4,431 passing plus seven intentional no-assert safety tests; 20,732 assertions; verified in CI on September 18, 2026; runs Godot headless)
