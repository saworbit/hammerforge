...
- **GUT unit + integration tests** -- 3,972 tests across 213 test scripts (3,965 passing plus seven intentional no-assert safety tests; 19,419 assertions; verified in CI on September 16, 2026; runs Godot headless)
