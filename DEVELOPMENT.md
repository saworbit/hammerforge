...
- **GUT unit + integration tests** -- 4,375 tests across 242 test scripts (4,368 passing plus seven intentional no-assert safety tests; 20,528 assertions; verified in CI on September 18, 2026; runs Godot headless)
