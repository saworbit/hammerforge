...
- **GUT unit + integration tests** -- 3,966 tests across 213 test scripts (3,959 passing plus seven intentional no-assert safety tests; 19,414 assertions; verified in CI on September 16, 2026; runs Godot headless)
