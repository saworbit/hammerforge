...
- **GUT unit + integration tests** -- 3,933 tests across 213 test scripts (3,926 passing plus seven intentional no-assert safety tests; 19,310 assertions; verified in CI on September 16, 2026; runs Godot headless)
