...
- **GUT unit + integration tests** -- 2,931 tests across 153 test scripts (2,924 passing plus seven intentional no-assert safety tests; 15,417 assertions; verified in CI on September 8, 2026; runs Godot headless)
