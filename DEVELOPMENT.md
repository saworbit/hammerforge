...
- **GUT unit + integration tests** -- 3,682 tests across 194 test scripts (3,675 passing plus seven intentional no-assert safety tests; 18,539 assertions; verified in CI on September 12, 2026; runs Godot headless)
