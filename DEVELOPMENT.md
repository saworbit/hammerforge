...
- **GUT unit + integration tests** -- 3,081 tests across 160 test scripts (3,074 passing plus seven intentional no-assert safety tests; 16,031 assertions; verified in CI on September 9, 2026; runs Godot headless)
