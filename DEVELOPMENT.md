...
- **GUT unit + integration tests** -- 4,210 tests across 235 test scripts (4,203 passing plus seven intentional no-assert safety tests; 20,090 assertions; verified in CI on September 17, 2026; runs Godot headless)
