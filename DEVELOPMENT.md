...
- **GUT unit + integration tests** -- 4,198 tests across 234 test scripts (4,191 passing plus seven intentional no-assert safety tests; 20,068 assertions; verified in CI on September 17, 2026; runs Godot headless)
