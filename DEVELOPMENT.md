...
- **GUT unit + integration tests** -- 4,446 tests across 243 test scripts (4,439 passing plus seven intentional no-assert safety tests; 20,752 assertions; verified in CI on September 18, 2026; runs Godot headless)
