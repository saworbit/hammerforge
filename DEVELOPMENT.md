...
- **GUT unit + integration tests** -- 4,288 tests across 236 test scripts (4,281 passing plus seven intentional no-assert safety tests; 20,279 assertions; verified in CI on September 17, 2026; runs Godot headless)
