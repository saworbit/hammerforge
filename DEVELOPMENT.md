...
- **GUT unit + integration tests** -- 3,913 tests across 212 test scripts (3,906 passing plus seven intentional no-assert safety tests; 19,244 assertions; verified in CI on September 16, 2026; runs Godot headless)
