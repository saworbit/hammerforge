...
- **GUT unit + integration tests** -- 2,922 tests across 153 test scripts (2,915 passing plus seven intentional no-assert safety tests; 15,393 assertions; verified in CI on September 8, 2026; runs Godot headless)
