...
- **GUT unit + integration tests** -- 3,998 tests across 214 test scripts (3,991 passing plus seven intentional no-assert safety tests; 19,492 assertions; verified in CI on September 16, 2026; runs Godot headless)
