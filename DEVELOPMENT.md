...
- **GUT unit + integration tests** -- 3,155 tests across 162 test scripts (3,148 passing plus seven intentional no-assert safety tests; 16,380 assertions; verified in CI on September 9, 2026; runs Godot headless)
