...
- **GUT unit + integration tests** -- 3,821 tests across 207 test scripts (3,814 passing plus seven intentional no-assert safety tests; 18,945 assertions; verified in CI on September 15, 2026; runs Godot headless)
