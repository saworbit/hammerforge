...
- **GUT unit + integration tests** -- 3,846 tests across 207 test scripts (3,839 passing plus seven intentional no-assert safety tests; 19,070 assertions; verified in CI on September 15, 2026; runs Godot headless)
