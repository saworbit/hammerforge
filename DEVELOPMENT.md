...
- **GUT unit + integration tests** -- 3,820 tests across 207 test scripts (3,813 passing plus seven intentional no-assert safety tests; 18,887 assertions; verified in CI on September 15, 2026; runs Godot headless)
