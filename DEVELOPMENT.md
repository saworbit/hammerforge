...
- **GUT unit + integration tests** -- 3,888 tests across 208 test scripts (3,881 passing plus seven intentional no-assert safety tests; 19,178 assertions; verified in CI on September 15, 2026; runs Godot headless)
