...
- **GUT unit + integration tests** -- 4,250 tests across 235 test scripts (4,243 passing plus seven intentional no-assert safety tests; 20,194 assertions; verified in CI on September 17, 2026; runs Godot headless)
