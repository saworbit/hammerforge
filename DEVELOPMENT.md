...
- **GUT unit + integration tests** -- 4,254 tests across 235 test scripts (4,247 passing plus seven intentional no-assert safety tests; 20,202 assertions; verified in CI on September 17, 2026; runs Godot headless)
