...
- **GUT unit + integration tests** -- 4,093 tests across 222 test scripts (4,086 passing plus seven intentional no-assert safety tests; 19,747 assertions; verified in CI on September 16, 2026; runs Godot headless)
