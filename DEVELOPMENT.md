...
- **GUT unit + integration tests** -- 4,490 tests across 247 test scripts (4,483 passing plus seven intentional no-assert safety tests; 20,845 assertions; verified in CI on September 19, 2026; runs Godot headless)
