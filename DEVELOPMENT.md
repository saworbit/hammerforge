...
- **GUT unit + integration tests** -- 3,863 tests across 207 test scripts (3,856 passing plus seven intentional no-assert safety tests; 19,099 assertions; verified in CI on September 15, 2026; runs Godot headless)
