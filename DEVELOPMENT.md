...
- **GUT unit + integration tests** -- 3,666 tests across 193 test scripts (3,659 passing plus seven intentional no-assert safety tests; 18,487 assertions; verified in CI on September 12, 2026; runs Godot headless)
