...
- **GUT unit + integration tests** -- 3,923 tests across 213 test scripts (3,916 passing plus seven intentional no-assert safety tests; 19,272 assertions; verified in CI on September 16, 2026; runs Godot headless)
