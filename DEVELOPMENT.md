...
- **GUT unit + integration tests** -- 4,471 tests across 243 test scripts (4,464 passing plus seven intentional no-assert safety tests; 20,807 assertions; verified in CI on September 19, 2026; runs Godot headless)
