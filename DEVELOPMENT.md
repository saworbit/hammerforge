...
- **GUT unit + integration tests** -- 3,670 tests across 192 test scripts (3,663 passing plus seven intentional no-assert safety tests; 18,513 assertions; verified in CI on September 12, 2026; runs Godot headless)
