...
- **GUT unit + integration tests** -- 4,160 tests across 229 test scripts (4,153 passing plus seven intentional no-assert safety tests; 19,945 assertions; verified in CI on September 17, 2026; runs Godot headless)
