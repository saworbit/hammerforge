...
- **GUT unit + integration tests** -- 4,242 tests across 235 test scripts (4,235 passing plus seven intentional no-assert safety tests; 20,177 assertions; verified in CI on September 17, 2026; runs Godot headless)
