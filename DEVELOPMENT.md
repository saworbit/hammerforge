...
- **GUT unit + integration tests** -- 4,053 tests across 219 test scripts (4,046 passing plus seven intentional no-assert safety tests; 19,652 assertions; verified in CI on September 16, 2026; runs Godot headless)
