...
- **GUT unit + integration tests** -- 4,358 tests across 241 test scripts (4,351 passing plus seven intentional no-assert safety tests; 20,481 assertions; verified in CI on September 18, 2026; runs Godot headless)
