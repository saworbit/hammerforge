...
- **GUT unit + integration tests** -- 3,938 tests across 213 test scripts (3,931 passing plus seven intentional no-assert safety tests; 19,325 assertions; verified in CI on September 16, 2026; runs Godot headless)
