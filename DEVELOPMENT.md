...
- **GUT unit + integration tests** -- 3,876 tests across 208 test scripts (3,869 passing plus seven intentional no-assert safety tests; 19,150 assertions; verified in CI on September 15, 2026; runs Godot headless)
