...
- **GUT unit + integration tests** -- 3,302 tests across 171 test scripts (3,295 passing plus seven intentional no-assert safety tests; 16,771 assertions; verified in CI on September 10, 2026; runs Godot headless)
