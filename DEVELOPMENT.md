...
- **GUT unit + integration tests** -- 3,306 tests across 171 test scripts (3,299 passing plus seven intentional no-assert safety tests; 16,741 assertions; verified in CI on September 10, 2026; runs Godot headless)
