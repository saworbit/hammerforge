...
- **GUT unit + integration tests** -- 3,900 tests across 210 test scripts (3,893 passing plus seven intentional no-assert safety tests; 19,196 assertions; verified in CI on September 15, 2026; runs Godot headless)
