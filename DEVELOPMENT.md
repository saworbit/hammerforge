...
- **GUT unit + integration tests** -- 4,037 tests across 218 test scripts (4,030 passing plus seven intentional no-assert safety tests; 19,570 assertions; verified in CI on September 16, 2026; runs Godot headless)
