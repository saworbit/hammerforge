...
- **GUT unit + integration tests** -- 3,919 tests across 213 test scripts (3,912 passing plus seven intentional no-assert safety tests; 19,238 assertions; verified in CI on September 16, 2026; runs Godot headless)
