...
- **GUT unit + integration tests** -- 3,831 tests across 207 test scripts (3,824 passing plus seven intentional no-assert safety tests; 18,992 assertions; verified in CI on September 15, 2026; runs Godot headless)
