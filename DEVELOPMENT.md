...
- **GUT unit + integration tests** -- 4,239 tests across 235 test scripts (4,232 passing plus seven intentional no-assert safety tests; 20,171 assertions; verified in CI on September 17, 2026; runs Godot headless)
