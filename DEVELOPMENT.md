...
- **GUT unit + integration tests** -- 4,452 tests across 243 test scripts (4,445 passing plus seven intentional no-assert safety tests; 20,765 assertions; verified in CI on September 18, 2026; runs Godot headless)
