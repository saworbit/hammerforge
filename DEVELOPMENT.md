...
- **GUT unit + integration tests** -- 4,178 tests across 232 test scripts (4,171 passing plus seven intentional no-assert safety tests; 19,994 assertions; verified in CI on September 17, 2026; runs Godot headless)
