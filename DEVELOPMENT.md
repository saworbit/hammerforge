...
- **GUT unit + integration tests** -- 3,815 tests across 207 test scripts (3,808 passing plus seven intentional no-assert safety tests; 18,883 assertions; verified in CI on September 15, 2026; runs Godot headless)
