...
- **GUT unit + integration tests** -- 3,956 tests across 213 test scripts (3,949 passing plus seven intentional no-assert safety tests; 19,376 assertions; verified in CI on September 16, 2026; runs Godot headless)
