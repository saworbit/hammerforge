...
- **GUT unit + integration tests** -- 3,819 tests across 208 test scripts (3,812 passing plus seven intentional no-assert safety tests; 18,885 assertions; verified in CI on September 15, 2026; runs Godot headless)
