...
- **GUT unit + integration tests** -- 3,878 tests across 208 test scripts (3,871 passing plus seven intentional no-assert safety tests; 19,152 assertions; verified in CI on September 15, 2026; runs Godot headless)
