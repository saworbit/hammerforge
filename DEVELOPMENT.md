...
- **GUT unit + integration tests** -- 3,872 tests across 208 test scripts (3,865 passing plus seven intentional no-assert safety tests; 19,141 assertions; verified in CI on September 15, 2026; runs Godot headless)
