...
- **GUT unit + integration tests** -- 4,127 tests across 224 test scripts (4,120 passing plus seven intentional no-assert safety tests; 19,807 assertions; verified in CI on September 17, 2026; runs Godot headless)
