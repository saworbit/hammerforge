...
- **GUT unit + integration tests** -- 3,839 tests across 207 test scripts (3,832 passing plus seven intentional no-assert safety tests; 19,060 assertions; verified in CI on September 15, 2026; runs Godot headless)
