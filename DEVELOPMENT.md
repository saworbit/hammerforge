...
- **GUT unit + integration tests** -- 4,168 tests across 231 test scripts (4,161 passing plus seven intentional no-assert safety tests; 19,963 assertions; verified in CI on September 17, 2026; runs Godot headless)
