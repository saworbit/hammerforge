...
- **GUT unit + integration tests** -- 4,041 tests across 218 test scripts (4,034 passing plus seven intentional no-assert safety tests; 19,581 assertions; verified in CI on September 16, 2026; runs Godot headless)
