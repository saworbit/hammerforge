...
- **GUT unit + integration tests** -- 4,396 tests across 242 test scripts (4,389 passing plus seven intentional no-assert safety tests; 20,608 assertions; verified in CI on September 18, 2026; runs Godot headless)
