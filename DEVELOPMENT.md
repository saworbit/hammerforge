...
- **GUT unit + integration tests** -- 4,111 tests across 222 test scripts (4,104 passing plus seven intentional no-assert safety tests; 19,762 assertions; verified in CI on September 17, 2026; runs Godot headless)
