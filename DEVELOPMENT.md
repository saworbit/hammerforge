...
- **GUT unit + integration tests** -- 3,997 tests across 214 test scripts (3,990 passing plus seven intentional no-assert safety tests; 19,483 assertions; verified in CI on September 16, 2026; runs Godot headless)
