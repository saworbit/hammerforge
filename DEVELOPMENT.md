...
- **GUT unit + integration tests** -- 3,182 tests across 163 test scripts (3,175 passing plus seven intentional no-assert safety tests; 16,415 assertions; verified in CI on September 9, 2026; runs Godot headless)
