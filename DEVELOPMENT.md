...
- **GUT unit + integration tests** -- 3,822 tests across 208 test scripts (3,815 passing plus seven intentional no-assert safety tests; 18,919 assertions; verified in CI on September 15, 2026; runs Godot headless)
