...
- **GUT unit + integration tests** -- 3,929 tests across 213 test scripts (3,922 passing plus seven intentional no-assert safety tests; 19,301 assertions; verified in CI on September 16, 2026; runs Godot headless)
