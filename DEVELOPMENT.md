...
- **GUT unit + integration tests** -- 2,874 tests across 151 test scripts (2,867 passing plus seven intentional no-assert safety tests; 15,210 assertions; verified locally September 8, 2026; runs Godot headless)
