...
- **GUT unit + integration tests** -- 4,371 tests across 242 test scripts (4,364 passing plus seven intentional no-assert safety tests; 20,509 assertions; verified in CI on September 18, 2026; runs Godot headless)
