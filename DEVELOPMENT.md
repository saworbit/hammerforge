...
- **GUT unit + integration tests** -- 3,907 tests across 211 test scripts (3,900 passing plus seven intentional no-assert safety tests; 19,202 assertions; verified in CI on September 15, 2026; runs Godot headless)
