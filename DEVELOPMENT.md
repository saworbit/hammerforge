...
- **GUT unit + integration tests** -- 4,284 tests across 236 test scripts (4,277 passing plus seven intentional no-assert safety tests; 20,267 assertions; verified in CI on September 17, 2026; runs Godot headless)
