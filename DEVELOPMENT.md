...
- **GUT unit + integration tests** -- 3,332 tests across 171 test scripts (3,325 passing plus seven intentional no-assert safety tests; 16,870 assertions; verified in CI on September 11, 2026; runs Godot headless)
