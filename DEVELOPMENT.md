...
- **GUT unit + integration tests** -- 4,393 tests across 242 test scripts (4,386 passing plus seven intentional no-assert safety tests; 20,596 assertions; verified in CI on September 18, 2026; runs Godot headless)
