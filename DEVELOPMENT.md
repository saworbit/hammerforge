...
- **GUT unit + integration tests** -- 3,910 tests across 211 test scripts (3,903 passing plus seven intentional no-assert safety tests; 19,220 assertions; verified in CI on September 16, 2026; runs Godot headless)
