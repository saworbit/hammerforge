...
- **GUT unit + integration tests** -- 3,857 tests across 207 test scripts (3,850 passing plus seven intentional no-assert safety tests; 19,083 assertions; verified in CI on September 15, 2026; runs Godot headless)
