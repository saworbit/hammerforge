...
- **GUT unit + integration tests** -- 3,150 tests across 162 test scripts (3,143 passing plus seven intentional no-assert safety tests; 16,365 assertions; verified in CI on September 9, 2026; runs Godot headless)
