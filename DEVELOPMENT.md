...
- **GUT unit + integration tests** -- 3,988 tests across 213 test scripts (3,981 passing plus seven intentional no-assert safety tests; 19,471 assertions; verified in CI on September 16, 2026; runs Godot headless)
