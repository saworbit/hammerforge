...
- **GUT unit + integration tests** -- 4,353 tests across 240 test scripts (4,346 passing plus seven intentional no-assert safety tests; 20,468 assertions; verified in CI on September 17, 2026; runs Godot headless)
