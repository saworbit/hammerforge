...
- **GUT unit + integration tests** -- 4,215 tests across 235 test scripts (4,208 passing plus seven intentional no-assert safety tests; 20,106 assertions; verified in CI on September 17, 2026; runs Godot headless)
