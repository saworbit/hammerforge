...
- **GUT unit + integration tests** -- 2,236 tests across 126 test scripts (2,229 passing plus seven intentional no-assert safety tests; 9,307 assertions; verified locally September 6, 2026; runs Godot headless)
