...
- **GUT unit + integration tests** -- 3,980 tests across 214 test scripts (3,973 passing plus seven intentional no-assert safety tests; 19,441 assertions; verified in CI on September 16, 2026; runs Godot headless)
