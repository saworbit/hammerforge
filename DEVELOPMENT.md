...
- **GUT unit + integration tests** -- 3,308 tests across 171 test scripts (3,301 passing plus seven intentional no-assert safety tests; 16,752 assertions; verified in CI on September 10, 2026; runs Godot headless)
