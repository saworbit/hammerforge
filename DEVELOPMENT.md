...
- **GUT unit + integration tests** -- 3,216 tests across 165 test scripts (3,209 passing plus seven intentional no-assert safety tests; 16,469 assertions; verified in CI on September 9, 2026; runs Godot headless)
