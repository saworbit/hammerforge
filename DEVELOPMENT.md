...
- **GUT unit + integration tests** -- 3,977 tests across 213 test scripts (3,970 passing plus seven intentional no-assert safety tests; 19,438 assertions; verified in CI on September 16, 2026; runs Godot headless)
