...
- **GUT unit + integration tests** -- 3,917 tests across 213 test scripts (3,910 passing plus seven intentional no-assert safety tests; 19,251 assertions; verified in CI on September 16, 2026; runs Godot headless)
