...
- **GUT unit + integration tests** -- 3,928 tests across 213 test scripts (3,921 passing plus seven intentional no-assert safety tests; 19,298 assertions; verified in CI on September 16, 2026; runs Godot headless)
