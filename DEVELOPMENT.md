...
- **GUT unit + integration tests** -- 3,979 tests across 214 test scripts (3,972 passing plus seven intentional no-assert safety tests; 19,432 assertions; verified in CI on September 16, 2026; runs Godot headless)
