...
func apply_cleanup(layer: HFPaintLayer, dirty_chunks: Array[Vector2i], intent: StringName, settings: InferenceSettings) -> void:
...
func _cleanup_chunk(layer: HFPaintLayer, cid: Vector2i, intent: StringName, s: InferenceSettings) -> void:
