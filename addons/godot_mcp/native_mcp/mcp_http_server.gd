...
func start() -> bool:
	...
	# Keep the editor-control endpoint on loopback unless remote access was
	# explicitly enabled. The upstream implementation stored _allow_remote but
	# otherwise listened on every interface.
