...
Full suite (verified in CI on September 18, 2026): **4,380 tests** across **242 scripts** (**4,373 passing** plus seven intentional no-assert safety tests; **20,547 assertions**).
