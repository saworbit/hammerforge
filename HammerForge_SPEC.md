...
Full suite (verified in CI on September 9, 2026): **3,180 tests** across **163 scripts** (**3,173 passing** plus seven intentional no-assert safety tests; **16,415 assertions**).
