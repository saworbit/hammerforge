...
Full suite (verified in CI on September 16, 2026): **3,934 tests** across **213 scripts** (**3,927 passing** plus seven intentional no-assert safety tests; **19,312 assertions**).
