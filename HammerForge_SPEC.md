...
Full suite (verified in CI on September 18, 2026): **4,371 tests** across **242 scripts** (**4,364 passing** plus seven intentional no-assert safety tests; **20,509 assertions**).
