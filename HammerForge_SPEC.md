...
Full suite (verified in CI on September 16, 2026): **3,929 tests** across **213 scripts** (**3,922 passing** plus seven intentional no-assert safety tests; **19,301 assertions**).
