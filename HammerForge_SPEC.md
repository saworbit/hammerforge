...
Full suite (verified in CI on September 8, 2026): **2,997 tests** across **157 scripts** (**2,990 passing** plus seven intentional no-assert safety tests; **15,689 assertions**).
