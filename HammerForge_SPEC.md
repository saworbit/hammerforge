...
Full suite (verified in CI on September 9, 2026): **3,081 tests** across **160 scripts** (**3,074 passing** plus seven intentional no-assert safety tests; **16,031 assertions**).
