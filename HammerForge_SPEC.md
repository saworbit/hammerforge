...
Full suite (verified in CI on September 16, 2026): **4,053 tests** across **219 scripts** (**4,046 passing** plus seven intentional no-assert safety tests; **19,652 assertions**).
