...
Full suite (verified in CI on September 16, 2026): **4,014 tests** across **216 scripts** (**4,007 passing** plus seven intentional no-assert safety tests; **19,524 assertions**).
