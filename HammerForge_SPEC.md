...
Full suite (verified in CI on September 17, 2026): **4,277 tests** across **236 scripts** (**4,270 passing** plus seven intentional no-assert safety tests; **20,251 assertions**).
