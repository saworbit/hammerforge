...
Full suite (verified locally on September 8, 2026): **2,582 tests** across **137 scripts** (**2,575 passing** plus seven intentional no-assert safety tests; **10,934 assertions**).
