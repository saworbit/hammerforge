...
Full suite (verified in CI on September 18, 2026): **4,361 tests** across **241 scripts** (**4,354 passing** plus seven intentional no-assert safety tests; **20,505 assertions**).
