...
Full suite (verified in CI on September 15, 2026): **3,872 tests** across **208 scripts** (**3,865 passing** plus seven intentional no-assert safety tests; **19,141 assertions**).
