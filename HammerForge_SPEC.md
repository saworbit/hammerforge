...
Full suite (verified in CI on September 17, 2026): **4,250 tests** across **235 scripts** (**4,243 passing** plus seven intentional no-assert safety tests; **20,194 assertions**).
