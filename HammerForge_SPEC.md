...
Full suite (verified in CI on September 12, 2026): **3,689 tests** across **195 scripts** (**3,682 passing** plus seven intentional no-assert safety tests; **18,567 assertions**).
