...
Full suite (verified in CI on September 17, 2026): **4,160 tests** across **229 scripts** (**4,153 passing** plus seven intentional no-assert safety tests; **19,945 assertions**).
