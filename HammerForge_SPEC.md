...
Full suite (verified in CI on September 16, 2026): **4,024 tests** across **217 scripts** (**4,017 passing** plus seven intentional no-assert safety tests; **19,544 assertions**).
