...
Full suite (verified in CI on September 17, 2026): **4,215 tests** across **235 scripts** (**4,208 passing** plus seven intentional no-assert safety tests; **20,106 assertions**).
