...
Full suite (verified in CI on September 17, 2026): **4,246 tests** across **235 scripts** (**4,239 passing** plus seven intentional no-assert safety tests; **20,186 assertions**).
