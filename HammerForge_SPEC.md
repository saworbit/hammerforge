...
Full suite (verified in CI on September 17, 2026): **4,198 tests** across **234 scripts** (**4,191 passing** plus seven intentional no-assert safety tests; **20,068 assertions**).
