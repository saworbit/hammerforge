...
Full suite (verified in CI on September 17, 2026): **4,239 tests** across **235 scripts** (**4,232 passing** plus seven intentional no-assert safety tests; **20,171 assertions**).
