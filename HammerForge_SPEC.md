...
Full suite (verified in CI on September 16, 2026): **4,049 tests** across **219 scripts** (**4,042 passing** plus seven intentional no-assert safety tests; **19,641 assertions**).
