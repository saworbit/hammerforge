...
Full suite (verified in CI on September 17, 2026): **4,136 tests** across **225 scripts** (**4,129 passing** plus seven intentional no-assert safety tests; **19,892 assertions**).
