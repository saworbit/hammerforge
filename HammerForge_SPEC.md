...
Full suite (verified in CI on September 16, 2026): **3,923 tests** across **213 scripts** (**3,916 passing** plus seven intentional no-assert safety tests; **19,274 assertions**).
