...
Full suite (verified in CI on September 9, 2026): **3,216 tests** across **165 scripts** (**3,209 passing** plus seven intentional no-assert safety tests; **16,469 assertions**).
