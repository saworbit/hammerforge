...
Full suite (verified in CI on September 17, 2026): **4,235 tests** across **235 scripts** (**4,228 passing** plus seven intentional no-assert safety tests; **20,153 assertions**).
