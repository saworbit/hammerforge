...
Full suite (verified in CI on September 17, 2026): **4,254 tests** across **235 scripts** (**4,247 passing** plus seven intentional no-assert safety tests; **20,202 assertions**).
