...
Full suite (verified in CI on September 15, 2026): **3,878 tests** across **208 scripts** (**3,871 passing** plus seven intentional no-assert safety tests; **19,152 assertions**).
