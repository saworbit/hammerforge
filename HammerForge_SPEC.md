...
Full suite (verified in CI on September 16, 2026): **4,004 tests** across **215 scripts** (**3,997 passing** plus seven intentional no-assert safety tests; **19,503 assertions**).
