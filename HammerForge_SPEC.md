...
Full suite (verified in CI on September 17, 2026): **4,353 tests** across **240 scripts** (**4,346 passing** plus seven intentional no-assert safety tests; **20,468 assertions**).
