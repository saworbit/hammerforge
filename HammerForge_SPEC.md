...
Full suite (verified in CI on September 8, 2026): **2,912 tests** across **153 scripts** (**2,905 passing** plus seven intentional no-assert safety tests; **15,349 assertions**).
