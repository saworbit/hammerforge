...
Full suite (verified in CI on September 17, 2026): **4,155 tests** across **228 scripts** (**4,148 passing** plus seven intentional no-assert safety tests; **19,924 assertions**).
