...
Full suite (verified in CI on September 9, 2026): **3,150 tests** across **162 scripts** (**3,143 passing** plus seven intentional no-assert safety tests; **16,365 assertions**).
