...
Full suite (verified in CI on September 17, 2026): **4,305 tests** across **237 scripts** (**4,298 passing** plus seven intentional no-assert safety tests; **20,323 assertions**).
