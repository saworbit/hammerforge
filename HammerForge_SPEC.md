...
Full suite (verified in CI on September 15, 2026): **3,820 tests** across **208 scripts** (**3,813 passing** plus seven intentional no-assert safety tests; **18,883 assertions**).
