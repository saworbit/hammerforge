...
- **Structure section** (Ctrl+Shift+A): builds whatever type the section is showing, placed on the selection or the world origin. The shortcut keeps the action id `create_arch` so existing custom keymaps still resolve.
...
Full suite (verified locally on September 8, 2026): **2,809 tests** across **147 scripts** (**2,802 passing** plus seven intentional no-assert safety tests; **15,006 assertions**).
