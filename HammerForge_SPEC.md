...
Full suite (verified in CI on September 17, 2026): **4,349 tests** across **240 scripts** (**4,342 passing** plus seven intentional no-assert safety tests; **20,460 assertions**).
