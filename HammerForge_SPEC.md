...
Full suite (verified in CI on September 18, 2026): **4,399 tests** across **242 scripts** (**4,392 passing** plus seven intentional no-assert safety tests; **20,617 assertions**).
