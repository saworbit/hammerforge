...
Full suite (verified in CI on September 17, 2026): **4,164 tests** across **230 scripts** (**4,157 passing** plus seven intentional no-assert safety tests; **19,956 assertions**).
