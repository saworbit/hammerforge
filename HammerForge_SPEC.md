...
Full suite (verified in CI on September 19, 2026): **4,490 tests** across **247 scripts** (**4,483 passing** plus seven intentional no-assert safety tests; **20,845 assertions**).
