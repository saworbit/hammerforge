...
Full suite (verified in CI on September 18, 2026): **4,388 tests** across **242 scripts** (**4,381 passing** plus seven intentional no-assert safety tests; **20,588 assertions**).
