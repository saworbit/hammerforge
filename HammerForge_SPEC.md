...
Full suite (verified in CI on September 17, 2026): **4,224 tests** across **235 scripts** (**4,217 passing** plus seven intentional no-assert safety tests; **20,120 assertions**).
