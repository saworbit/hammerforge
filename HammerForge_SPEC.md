...
Full suite (verified in CI on September 16, 2026): **3,924 tests** across **213 scripts** (**3,917 passing** plus seven intentional no-assert safety tests; **19,274 assertions**).
