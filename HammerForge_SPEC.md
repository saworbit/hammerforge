...
Full suite (verified in CI on September 16, 2026): **3,910 tests** across **211 scripts** (**3,903 passing** plus seven intentional no-assert safety tests; **19,220 assertions**).
