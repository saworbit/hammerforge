...
Full suite (verified in CI on September 9, 2026): **3,198 tests** across **164 scripts** (**3,191 passing** plus seven intentional no-assert safety tests; **16,445 assertions**).
