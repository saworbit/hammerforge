...
Full suite (verified in CI on September 9, 2026): **3,236 tests** across **166 scripts** (**3,229 passing** plus seven intentional no-assert safety tests; **16,493 assertions**).
