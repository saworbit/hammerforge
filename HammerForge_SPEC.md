...
Full suite (verified in CI on September 16, 2026): **3,911 tests** across **212 scripts** (**3,904 passing** plus seven intentional no-assert safety tests; **19,208 assertions**).
