...
Full suite (verified in CI on September 16, 2026): **3,956 tests** across **213 scripts** (**3,949 passing** plus seven intentional no-assert safety tests; **19,376 assertions**).
