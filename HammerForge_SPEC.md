...
Full suite (verified in CI on September 9, 2026): **3,004 tests** across **157 scripts** (**2,997 passing** plus seven intentional no-assert safety tests; **15,707 assertions**).
