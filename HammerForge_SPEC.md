...
- **Relocation and hand edits**: each record keeps a per-piece signature of where the piece was put and a hash of what it is. A structure whose surviving pieces all moved by the same delta is relocated, and rebuilds where it now stands; pieces that disagree were edited individually. A piece whose geometry hash differs is counted as edited, and the Structure section says how many a rebuild would overwrite.
