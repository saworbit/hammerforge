...
Full suite (verified in CI on September 16, 2026): **3,914 tests** across **212 scripts** (**3,907 passing** plus seven intentional no-assert safety tests; **19,228 assertions**).
