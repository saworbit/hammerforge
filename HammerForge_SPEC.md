...
Full suite (verified in CI on September 16, 2026): **3,960 tests** across **213 scripts** (**3,953 passing** plus seven intentional no-assert safety tests; **19,382 assertions**).
