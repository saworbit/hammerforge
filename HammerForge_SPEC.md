...
Full suite (verified in CI on September 17, 2026): **4,233 tests** across **235 scripts** (**4,226 passing** plus seven intentional no-assert safety tests; **20,150 assertions**).
