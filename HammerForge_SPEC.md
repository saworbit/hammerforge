...
Full suite (verified in CI on September 16, 2026): **4,041 tests** across **218 scripts** (**4,034 passing** plus seven intentional no-assert safety tests; **19,581 assertions**).
