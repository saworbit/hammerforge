...
Full suite (verified in CI on September 18, 2026): **4,393 tests** across **242 scripts** (**4,386 passing** plus seven intentional no-assert safety tests; **20,596 assertions**).
