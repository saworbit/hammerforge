...
Full suite (verified in CI on September 16, 2026): **4,037 tests** across **218 scripts** (**4,030 passing** plus seven intentional no-assert safety tests; **19,570 assertions**).
