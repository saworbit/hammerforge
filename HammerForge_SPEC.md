...
Full suite (verified in CI on September 9, 2026): **3,035 tests** across **158 scripts** (**3,028 passing** plus seven intentional no-assert safety tests; **15,869 assertions**).
