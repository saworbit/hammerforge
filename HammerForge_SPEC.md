...
Full suite (verified in CI on September 18, 2026): **4,447 tests** across **243 scripts** (**4,440 passing** plus seven intentional no-assert safety tests; **20,753 assertions**).
