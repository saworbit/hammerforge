...
Full suite (verified in CI on September 16, 2026): **3,933 tests** across **213 scripts** (**3,926 passing** plus seven intentional no-assert safety tests; **19,310 assertions**).
