...
Full suite (verified in CI on September 16, 2026): **4,007 tests** across **215 scripts** (**4,000 passing** plus seven intentional no-assert safety tests; **19,503 assertions**).
