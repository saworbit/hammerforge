...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1882%20passing-brightgreen" alt="1882 tests passing">
...
The verified Godot 4.7 CI run on September 3, 2026 contains **1,889 tests across 109 scripts**: **1,882 passing tests**, seven intentional no-assert safety tests, and **8,161 assertions**. All checks run on every push and pull request via GitHub Actions.
