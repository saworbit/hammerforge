...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1881%20passing-brightgreen" alt="1881 tests passing">
...
The verified Godot 4.7 CI run on September 3, 2026 contains **1,888 tests across 109 scripts**: **1,881 passing tests**, seven intentional no-assert safety tests, and **8,140 assertions**. All checks run on every push and pull request via GitHub Actions.
