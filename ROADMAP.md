...
The current suite covers 4,521 tests across 249 scripts, including the large brush, bake, paint, vertex, transform, generator, baker, brush-instance, and map-I/O systems. Every known limitation is either covered by tests or written down beside the wave that introduced it.
